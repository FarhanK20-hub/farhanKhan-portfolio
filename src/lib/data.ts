...
export const CLIENTS_LIST = [
  ...
  '/logos/Kenzo.png',
  '/logos/Kita.png',
  '/logos/NOORVI-02_229f2a70-0773-4b2d-a84a-3db7cfa3f851.webp',
  '/logos/Navneet-Logo-Name_2-1.png',
  '/logos/P L A N S.png',
  '/logos/Panache 26.png',
  '/logos/SI logo white (1).png',
  '/logos/SPSU.png',
  '/logos/The Pet Partner.png',
  '/logos/adquarters_india_logo.jpg',
  '/logos/airavat.png',
  '/logos/challengefitness.png',
  '/logos/hf_20260331_060142_ea1a34f0-61c2-48e6-9e97-1d2e8c8f82dc - Edited.png',
  '/logos/images.png',
  '/logos/kn.png',
  '/logos/logo--1.png',
  '/logos/logo1.png',
